  ...
  return (
    <div className="container" style={{ padding: "32px 16px", maxWidth: "1000px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "24px" }}>
        <Link href="/admin/products" style={{ padding: "8px", backgroundColor: "var(--card-bg)", borderRadius: "var(--radius-sm)", border: "1px solid var(--border-color)" }}>
          <ArrowLeft size={20} />
        </Link>
        <h1 style={{ color: "var(--text-main)", fontSize: "24px", margin: 0 }}>Mahsulotni tahrirlash</h1>
      </div>
      ...
      <div className="responsive-flex" style={{ display: "flex", gap: "32px", alignItems: "flex-start" }}>
        ...
        <div style={{ width: "320px", display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <button className="btn btn-primary" onClick={handleUpdate} disabled={saving} style={{ width: "100%", padding: "16px", fontSize: "16px", display: "flex", gap: "8px", justifyContent: "center", opacity: saving ? 0.7 : 1 }}>
            <Save size={20} />
